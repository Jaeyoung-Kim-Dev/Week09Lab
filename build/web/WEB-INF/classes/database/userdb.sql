...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('naeun.kim@calgary.ca', true, 'Naeun','Kim', 'password', 3);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('jaeyoung.kim@calgary.ca', true, 'Jaeyoung','Kim', 'password', 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('aaron.warsylewicz@calgary.ca', true, 'Aaron','Warsylewicz', 'password', 2);
